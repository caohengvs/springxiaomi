...
public class EmailUtils {
    public static void sendEmail(User user){
        //发送方
        String myAccount = "m18637891729@163.com";
        //授权码
        String myPass = "SONGYU8959";
        //发件人 邮箱的 SMTP 服务器地址
    ...
    private static MimeMessage createMsg(Session session, String myAccount, User user) {
        ...
        try {
            ...
            String url = "http://"+ip+":8080/spring_xiaomi_partent/activate?e="+ Base64Utils.encode(user.getEmail())+"&c="+Base64Utils.encode(user.getCode());
